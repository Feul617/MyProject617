...
class Zombie:
    ...
    def get_next_position(self):
        ...
        self.patrol_order += 1
        self.dir = math.atan2(self.target_y - self.y, self.target_x - self.x) # atan2는 파라미터가 2개여서 분모가 0이 되는 경우를 방지할 수 있다
    ...
    def move_to_target(self):
        ...
        if distance2 < PIXEL_PER_METER**2: # 거리가 1미터 이내이면
            print('Move to Traget Success')
            return BehaviorTree.SUCCESS # 도착
        else:
